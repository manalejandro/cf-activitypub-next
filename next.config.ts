...
const cspHeader = [
  ...
  // 'self' is required to load _next/static chunks. Cloudflare hosts are for
  // Turnstile (challenges) and Web Analytics (cloudflareinsights).
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.cloudflareinsights.com https://challenges.cloudflare.com https://nominatim.openstreetmap.org",
